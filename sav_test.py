#!/usr/bin/env python3
"""
Benchmark HOSVD variants on SA-V test.
Usage:
    srun python benchmark_sav_test.py
    srun python benchmark_sav_test.py --ranks 48 64 --skip_hosvd
    srun python benchmark_sav_test.py --only_baseline
    srun python benchmark_sav_test.py --no_clean --skip_baseline --ranks 48
"""
...
VIDEO_DIR     = "/home/ids/lnguyen-23/haianh/data/SA-V/sav_test/JPEGImages_24fps"
MASK_DIR      = "/home/ids/lnguyen-23/haianh/data/SA-V/sav_test/Annotations_6fps"
VIDEO_LIST    = "/home/ids/lnguyen-23/haianh/data/SA-V/sav_test/sav_test.txt"
EVAL_CWD      = Path("/home/ids/lnguyen-23/haianh/evaluation/sav_dataset")
EVAL_SCRIPT   = str(EVAL_CWD / "sav_evaluator.py")
GT_MASK_DIR   = "/home/ids/lnguyen-23/haianh/data/SA-V/sav_test/Annotations_6fps"
RESULTS_BASE  = Path("/home/ids/lnguyen-23/haianh/evaluation/sav_test/results")
LOG_FILE      = Path("/home/ids/lnguyen-23/haianh/evaluation/sav_test/benchmark_results.log")

DEFAULT_SI_RANKS = [16, 32, 48, 64]

# JSON file that accumulates results across runs (for plotting later)
RESULTS_JSON = Path("/home/ids/lnguyen-23/haianh/evaluation/sav_test/benchmark_results.json")
...
def print_summary(data: dict):
    ...
    log.info("")
    log.info("┌─────────────────────────────────────────────────┐")
    log.info("│              SA-V test — Results Summary         │")
    log.info("├────────────────────────────────────┬────┬────┬────┤")
...
def parse_args():
    p = argparse.ArgumentParser(description="Benchmark HOSVD variants on SA-V test")
...
def main():
    ...
    # ── header ───────────────────────────────────────────────────────────
    log.info("════════════════════════════════════════")
    log.info(f"  HOSVD Benchmark — SA-V test")
